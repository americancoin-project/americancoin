...
// Copyright (c) 2011-2013 Americancoin Developers
...
const string strMessageMagic = "Americancoin Signed Message:\n";
...
//static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Americancoin: 3.5 days
static const int64 nTargetTimespan = (7 * 24 * 60 * 60) / 8; //  Americancoin: 7/8 days
static const int64 nTargetSpacing = 2.5 * 60; // Americancoin: 2.5 minutes
...
unsigned int static GetNextWorkRequiredOld(const CBlockIndex* pindexLast, const CBlock *pblock)
{
	...
	// AmericanCoin difficulty adjustment protocol switch
    static const int nDifficultySwitchHeight = 14000;
    ...
    // Americancoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal americancoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Americancoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("4104678afdb0fe5548261967f1a67130b7102cd6a828e03909a67962e0ea1f61deb649f6ca3f4cef38c4f35504e51ec102ee5c384df7ba0b8d578a4c702b6bf11d5fac") << OP_CHECKSIG;
        CBlock block;
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Americancoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
